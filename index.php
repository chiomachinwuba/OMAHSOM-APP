	...
	<div class="col-lg-4">
		<div class="jumbotron">
			<div class="container text-center">
				<h1>Join The Top Freelancing Marketplace</h1>
				<h5>Believe in yourself and all that you are. <br> Know that there is something inside you <br> that is greater than any obstacle.</h5> <br>
